...
public class EditTextAppWork extends AppCompatEditText {

	public EditTextAppWork(Context context) {
		super(context);
		init(context, null);
	}
	
	public EditTextAppWork(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
	}
	
	public EditTextAppWork(Context context, AttributeSet attrs, int defStyle) {
