 ...
 */
public class RatingBarAppWork extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.ic_star_on;
    private int mStarOffResource = R.drawable.ic_star_off;
    private int mStarHalfResource = R.drawable.ic_star_half;
    ...
    public RatingBarAppWork(Context context) {
        super(context);
        init();
    }
    ...
    public RatingBarAppWork(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public RatingBarAppWork(Context context, AttributeSet attrs, int defStyle) {
